...
<p style="margin:16px 0 0;font-size:15px;line-height:1.55;color:#363636;">Todo se guarda en privado: solo lo procesan los servicios que la app necesita para funcionar, como la inteligencia artificial que arma los outfits, y nunca se vende. Puedes retirar el permiso y pedir que borremos sus datos cuando quieras, escribiendo a <a href="mailto:hola@stailist.co" style="color:#141414;">hola@stailist.co</a>. El detalle completo está en el <a href="https://stailist.co/privacidad" style="color:#141414;">aviso de privacidad</a>.</p>
