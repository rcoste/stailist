...
function idealArgs(item: CapsuleItem): RenderArgs {
  return {
    tipo: item.tipo,
...
// Expone `start()` explícito con estado de carga (en vez del render auto-silencioso
// del viejo Thumb) para poder mostrar la capa de "creando imagen…".
function useIdealRender(renderArgs: RenderArgs, initialSrc: string | null) {
...
type IdealRender = ReturnType<typeof useIdealRender>;
