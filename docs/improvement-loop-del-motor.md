...
| 08-24 | 8130c381 | v66 | prompt-anterior (v65) | ⏳ sin votar | pre-registrado: v66 ("LA PIEZA primero" — el análisis elige la prenda con carácter ANTES que los neutros, exactamente una) entra a main solo si aprobación ≥ control. Nace del diagnóstico del eval 919c2f53: 14/45 looks sin prenda con carácter (estilo 3.29 vs 3.81 con una, 3.45 con dos), calzado negro 62%, 59/130 prendas jamás usadas. Rama `motor-v66`, NO en main hasta el voto |
