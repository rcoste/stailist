...
| 08-24 | 2f307042 | v67 | sin-reglas-v67 | ⏳ sin votar | pre-registrado: las reglas de v67 (chelsea-en-calor + tip del saco cruzado abotonado, ambas con 2 menciones en rondas distintas) entran a main solo si aprobación ≥. Ablación previa: chelsea 1👎 + 1👍 cuyo comentario CONFIRMA el principio ("la chelsea boot no es tan adhoc para clima de calor" — patrón cueros); tip del cruzado 2👎/0👍, validado contra los 4 tips reales. La ronda SÍ ejercita chelsea (a 29° el lado sin reglas sacó Chelsea — su juez la metió reparando cueros); el tip del cruzado NO se ejercitó (ningún look sacó el cruzado): su validación queda en ablación+tests, como reloj/corbata en su día. Rama `motor-v67` |
