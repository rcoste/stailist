...
| 08-24 | 7abd9c9c | v61 | sin-reglas-v61 | **75%** vs 71% | pre-registrado "≥" cumplido: **v61 en main** (pares 2-2, 2 empates). js7 fuera de muestra: rompe 1/8, falsa alarma 2/22 — sigue viendo sin pesar. Comentarios nuevos: saco de traje como blazer (2×, ¿regla existente rota?), full lino en oficina OTRA VEZ (¿regla rota?), boda sin corbata (2ª), chelsea en calor |
