...
const WOMEN = [
  ...
  ["monocromatico","m3","a disciplined tonal grey monochrome look built on TEXTURE and VARIED shades of grey — a mid-grey fitted ribbed knit under a light-grey longline wool waistcoat, relaxed charcoal-grey trousers, and clean WHITE leather sneakers as a realistic neutral anchor; light-to-dark greys with matte wool and ribbed knit textures — an intentional tonal look, NOT one flat identical grey, and NEVER grey monochrome-soled sneakers","sleek straight loose hair, minimal and polished"],
...
const MEN = [
  ...
  ["color-protagonista","h1","ONE bold cobalt-blue statement piece styled with intention — an oversized cobalt-blue zip bomber jacket over a clean white tee, with relaxed straight-leg ecru trousers and white sneakers; everything else strictly neutral so the cobalt is the whole story, layered and well-proportioned — NOT a plain crew"],
  ...
  ["monocromatico","h2","a disciplined tonal grey monochrome look built on TEXTURE and VARIED shades of grey — a mid-grey ribbed knit under a light-grey wool waistcoat, relaxed charcoal-grey trousers, and clean WHITE leather sneakers as a realistic neutral anchor; light-to-dark greys with matte wool and ribbed knit textures — an intentional tonal look, NOT one flat identical grey head to toe, and NEVER grey monochrome-soled sneakers"],
