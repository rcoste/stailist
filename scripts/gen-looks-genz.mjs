...
const WOMEN = [
  ...
  ["monocromatico","m3","a disciplined head-to-toe tonal grey monochrome look built on TEXTURE — a fitted ribbed grey knit under a longline grey wool waistcoat, relaxed straight grey trousers and grey sneakers; matte wool, ribbed knit and suede in one grey family, an intentional tonal column with real texture play — NOT a plain knit and trouser","sleek straight loose hair, minimal and polished"],
...
const MEN = [
  ...
  ["monocromatico","h2","a disciplined head-to-toe tonal grey monochrome look built on TEXTURE — a ribbed grey knit layered under a grey wool waistcoat, relaxed straight grey trousers and grey suede sneakers; matte wool, ribbed knit and suede all in one grey family, an intentional tonal column with real texture play — NOT a plain crew and chino"],
