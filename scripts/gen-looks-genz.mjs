...
const WOMEN = [
  ...
  ["monocromatico","m3","a striking all-BLACK tonal monochrome look, tone-on-tone — a black fine-knit top tucked into relaxed high-waisted black trousers, sleek black leather ankle boots and a structured black leather bag; matte wool, fine knit and polished leather textures all in black — minimal, high-impact and intentional, ONE single colour is the whole statement","sleek straight loose hair, minimal and polished"],
